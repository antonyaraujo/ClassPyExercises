# A prefeitura de uma cidade abriu uma linha de crédito para os funcionários estatutários. O
# valor máximo da prestação não poderá ultrapassar 30% do salário bruto. Fazer um
