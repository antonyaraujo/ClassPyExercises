# Reescreva o programa anterior proposto número 6 incluindo uma validação na leitura da resposta de
# forma que enquanto o usuário não digitar um número considerado válido (0, 1, 2 ou -1), fica
# repetindo a leitura.
...
while (frequencia != (-1) ):
    ...
    if frequencia == 0:
        ...
        muitasvezes += 1
    while (frequencia != (-1) and frequencia != 1 and frequencia != 2 and frequencia != 3):
        frequencia = int(input("Com que frequência você faz exercícios? \n"))
